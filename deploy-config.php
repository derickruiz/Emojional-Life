 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'GonnaChangeThisLaterAfterStreaming');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/derickruiz/Emojional-Life.git');
 ...
 * @var string Full path including the trailing slash
 */
define('TMP_DIR', '/var/www/html/inletapp.com/tmp-' . md5(REMOTE_REPOSITORY) . '/');
